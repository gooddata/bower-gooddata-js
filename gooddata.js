...
/***/ function(module, exports, __webpack_require__) {
	...
	var _metadata = __webpack_require__(12);
	...
	var _catalogue = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.translateElementLabelsToUris = translateElementLabelsToUris;
	...
	*/
	...
	function translateElementLabelsToUris(projectId, labelUri, patterns) {
	    ...
	    return (0, _xhr.post)('/gdc/md/' + projectId + '/labels', {
	        body: {
	            elementLabelToUri: [{
	                labelUri: labelUri,
	                mode: mode,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _definitions = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _contracts = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateDomainSegment = exports.updateDomainSegment = function updateDomainSegment(domainSegment) {
	    return (0, _xhr.put)(routes.interpolate(routes.CONTRACT_DATA_PRODUCT_DOMAIN_SEGMENT, domainSegment), {
	        data: JSON.stringify({
	            domainSegment: _lodash2.default.omit(domainSegment, ['contractId', 'dataProductId', 'segmentId', 'domainId'])
	        })
	    }).then(function (result) {
	        return result.json();
	    }).then(function (result) {
